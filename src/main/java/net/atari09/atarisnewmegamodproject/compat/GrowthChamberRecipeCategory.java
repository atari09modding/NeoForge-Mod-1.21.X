...
public class GrowthChamberRecipeCategory implements IRecipeCategory<GrowthChamberRecipe> {
    public static final ResourceLocation UID = AtariMod.res("growth_chamber");
    public static final ResourceLocation TEXTURE = AtariMod.res("textures/gui/growth_chamber/growth_chamber_gui.png");
