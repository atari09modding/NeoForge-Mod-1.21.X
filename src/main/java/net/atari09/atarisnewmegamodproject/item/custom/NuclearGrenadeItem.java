...
public class NuclearGrenadeItem extends Item {
    public NuclearGrenadeItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide) {
            NuclearGrenadeEntity grenade = new NuclearGrenadeEntity(pPlayer, pLevel);
            grenade.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0.5F, 4F, 0.1F);
