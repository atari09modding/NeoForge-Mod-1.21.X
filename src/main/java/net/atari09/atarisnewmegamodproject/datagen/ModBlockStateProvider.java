...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlockWithRenderType(ModBlocks.BISMUTH_DOOR.get(), modLoc("blocks/bismuth_door_bottom"), modLoc("blocks/bismuth_door_top"), "cutout");
        trapdoorBlockWithRenderType(ModBlocks.BISMUTH_TRAPDOOR.get(), modLoc("blocks/bismuth_trapdoor"), true,"cutout");
